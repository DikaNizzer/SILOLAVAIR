    ...
    <div class="container">
      <div class="row align-items-center">
        ...
        <div class="col-md-7 col-lg-6 text-md-start text-center py-6">
          ...
          <h1 class="fs-6 fs-xl-7 mb-5">Sistem Informasi Pengelolaan Tugas Akhir Vokasi Unair</h1><a class="btn btn-primary me-2" href="#!" role="button">Get A Quote</a><a class="btn btn-outline-secondary" href="#!" role="button">Read more</a>
        </div>
      </div>
    </div>
  </section>
