...
<section class="pt-6 bg-600" id="home">
    <div class="container">
      <div class="row align-items-center">
        <div class="col-md-5 col-lg-6 order-0 order-md-1 text-end"><img class="pt-7 pt-md-0 w-100" src="landing/public/assets/img/gallery/hero-header.png" width="470" alt="hero-header" /></div>
        <div class="col-md-7 col-lg-6 text-md-start text-center py-6">
          <h4 class="fw-bold font-sans-serif">SILOLAVAIR</h4>
          <h1 class="fs-6 fs-xl-7 mb-5">Sistem Informasi Pengelolaan Tugas Akhir Vokasi Unair</h1>
        ...
        <div class="card card-span bg-secondary">
          <div class="card-body">
            <div class="row flex-center gx-0">
              <div class="col-lg-4 col-xl-2 text-center text-xl-start"><img src="landing/public/assets/img/gallery/funfacts.png" width="170" alt="..." /></div>
              <div class="col-lg-8 col-xl-4">
                <h1 class="text-light fs-lg-4 fs-xl-5">TA yang baik <span class="text-primary">Adalah TA yang </span>Selesai!</h1>
              </div>
              <div class="col-lg-12 col-xl-6">
                <h1 class="display-1 text-light text-center text-xl-end">2021 - 2022</h1>
              </div>
            </div>
          </div>
        </div>
...
{{--
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-4 mb-4">
          <div class="card h-100"><img class="card-img-top w-100" src="landing/public/assets/img/gallery/design.png" alt="courses" />
            <div class="card-body">
        ...
        <div class="col-md-4 mb-4">
          <div class="card h-100"><img class="card-img-top w-100" src="landing/public/assets/img/gallery/psychology.png" alt="courses" />
            <div class="card-body">
        ...
        <div class="col-md-4 mb-4">
          <div class="card h-100"><img class="card-img-top w-100" src="landing/public/assets/img/gallery/philosophy.png" alt="courses" />
            <div class="card-body">
        ...
        <div class="col-md-4 mb-4">
          <div class="card h-100"><img class="card-img-top w-100" src="landing/public/assets/img/gallery/photographs.png" alt="courses" />
            <div class="card-body">
        ...
        <div class="col-md-4 mb-4">
          <div class="card h-100"><img class="card-img-top w-100" src="landing/public/assets/img/gallery/arguments.png" alt="courses" />
            <div class="card-body">
        ...
        <div class="col-md-4 mb-4">
          <div class="card h-100"><img class="card-img-top w-100" src="landing/public/assets/img/gallery/experience-design.png" alt="courses" />
            <div class="card-body">
              <h5 class="font-sans-serif fw-bold fs-md-0 fs-lg-1">User Research for User Experience Design</h5><a class="text-muted fs--1 stretched-link text-decoration-none" href="#!">The Museum of Modern Art</a>
            </div>
          </div>
        ...
        <div class="col-md-4 mb-4">
          <div class="card h-100"><img class="card-img-top w-100" src="landing/public/assets/img/gallery/user-research.png" alt="courses" />
            <div class="card-body">
              <h5 class="font-sans-serif fw-bold fs-md-0 fs-lg-1">User Research for User Experience Design</h5><a class="text-muted fs--1 stretched-link text-decoration-none" href="#!">The Museum of Modern Art</a>
            </div>
          </div>
        ...
        <div class="col-md-4 mb-4">
          <div class="card h-100"><img class="card-img-top w-100" src="landing/public/assets/img/gallery/critical-thinking.png" alt="courses" />
            <div class="card-body">
        ...
        <div class="col-md-4 mb-4">
          <div class="card h-100"><img class="card-img-top w-100" src="landing/public/assets/img/gallery/art-design.png" alt="courses" />
            <div class="card-body">
    ...
    <div class="container">
      <div class="row h-100 align-items-center">
        <div class="col-md-12 col-lg-6 h-100">
          <div class="card card-span text-white h-100"><img class="w-100" src="landing/public/assets/img/gallery/student-feedback.png" alt="..." />
        ...
        <div class="col-md-12 col-lg-6 h-100">
          ...
          <div class="mt-6">
            ...
            <div class="card card-span bg-600">
              <div class="card-body">
                <div class="row flex-center gx-0">
                  <div class="col-lg-4 col-xl-3 text-center text-xl-start"><img src="landing/public/assets/img/gallery/art-design.png" width="120" alt="courses" /></div>
  ...
  <section>
    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-6 col-lg-3 text-center mb-5"><img src="landing/public/assets/img/gallery/published.png" height="100" alt="..." />
          <h1 class="my-2">768</h1>
          <p class="text-info fw-bold">COURSES PUBLISHED</p>
        </div>
        <div class="col-sm-6 col-lg-3 text-center mb-5"><img src="landing/public/assets/img/gallery/instructors.png" height="100" alt="..." />
          <h1 class="my-2">120</h1>
          <p class="text-info fw-bold">EXPERT INSTRUCTORS</p>
        </div>
        <div class="col-sm-6 col-lg-3 text-center mb-5"><img src="landing/public/assets/img/gallery/learners.png" height="100" alt="..." />
          <h1 class="my-2">8300</h1>
          <p class="text-info fw-bold">HAPPY LEARNERS</p>
        </div>
        <div class="col-sm-6 col-lg-3 text-center mb-5"><img src="landing/public/assets/img/gallery/awards.png" height="100" alt="..." />
          <h1 class="my-2">32</h1>
  ...
  <section>
    ...
    <div class="container">
      <div class="row align-items-center">
        <div class="col-md-6 col-lg-4 mb-5"><img src="landing/public/assets/img/gallery/cta.png" width="280" alt="cta" /></div>
  ...
  <section class="bg-secondary">
    ...
    <div class="container">
      <div class="row">
        <div class="col-12 col-sm-12 col-lg-6 mb-4 order-0 order-sm-0"><a class="text-decoration-none" href="#"><img src="landing/public/assets/img/gallery/footer-logo.png" height="51" alt="" /></a>
